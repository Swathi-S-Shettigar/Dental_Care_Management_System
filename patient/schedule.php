        ...
        <?php
                ...
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from schedule inner join doctor on schedule.docid=doctor.docid where schedule.scheduledate>='$today' and (doctor.docname like '%$keyword%' or schedule.title like '%$keyword%' or schedule.scheduledate like '%$keyword%' ) order by schedule.scheduledate asc";
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name or Email or Date (YYYY-MM-DD)" list="doctors" value="<?php  echo $insertkey ?>" required>&nbsp;&nbsp;
...
$result = $database->query($sqlmain);
if ($result === false) {
    die("Query execution failed: " . $database->error);
}
